...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var CSS = [
      ...
      "body[data-ds-dark-theme] .kwp-sidebar{background:#141518;border-right-color:#26272c}",
      "body[data-ds-dark-theme] .kwp-logo{color:#f5f6f7}",
      "body[data-ds-dark-theme] .kwp-nav{color:#a6abb4}",
      "body[data-ds-dark-theme] .kwp-nav:hover{background:#222329}",
      "body[data-ds-dark-theme] .kwp-navActive{background:#1f3a37;color:#2dd4bf}",
      "body[data-ds-dark-theme] .kwp-navBadge{background:#26272c;color:#a6abb4}",
      "body[data-ds-dark-theme] .kwp-navActive .kwp-navBadge{background:#0f766e;color:#fff}",
      "body[data-ds-dark-theme] .kwp-conv{color:#a6abb4}",
      "body[data-ds-dark-theme] .kwp-conv:hover{background:#222329}",
      "body[data-ds-dark-theme] .kwp-emptyHint{color:#757b84}",
      "body[data-ds-dark-theme] .kwp-foot{border-top-color:#26272c}",
      "body[data-ds-dark-theme] .kwp-manage{background:#1c1d21;border-color:#2a2b2f;color:#f5f6f7}",
      "body[data-ds-dark-theme] .kwp-tag{color:#2dd4bf;background:#1f3a37}",
      "body[data-ds-dark-theme] .kwp-search{background:#1c1d21;box-shadow:0 0 6px rgba(0,0,0,.4)}",
      "body[data-ds-dark-theme] .kwp-search:focus-within{border-color:#3a3b41}",
      "body[data-ds-dark-theme] .kwp-searchInput{color:#f5f6f7}",
      "body[data-ds-dark-theme] .kwp-searchInput::placeholder{color:#757b84}",
      "body[data-ds-dark-theme] .kwp-ghost{color:#a6abb4}",
      "body[data-ds-dark-theme] .kwp-ghost:hover{background:#222329}",
      "body[data-ds-dark-theme] .kwp-avatar{background:#2a2b2f;color:#9fb3e0}",
      "body[data-ds-dark-theme] .kwp-tabs{border-bottom-color:#26272c}",
      "body[data-ds-dark-theme] .kwp-tab{color:#757b84}",
      "body[data-ds-dark-theme] .kwp-tabActive{color:#f5f6f7;border-bottom-color:#f5f6f7}",
