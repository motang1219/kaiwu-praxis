...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var CSS = [
      ...
      ".kwp-entryLogo{margin-left:auto;display:inline-flex;align-items:center;color:inherit;opacity:.82;flex:none}",
      ".kwp-entryLogo svg{display:block}",
      ".kwp-logo{display:inline-flex;align-items:center;margin-left:6px;color:inherit;opacity:.92;flex:none}",
      ".kwp-logo svg{display:block}",
      ...
      "[data-dsh-frame][data-sidebar-collapsed] .kwp-entryLogo,[data-sidebar-collapsed] .kwp-entryLogo{display:none}",
    ...
    // 开物 Praxis 品牌 logo（来自 114122206273-kaiwu.svg，黑色 → 用 currentColor 跟随主题）。
    var KAIWU_MARK_PATH = "M134,0 C169.346224,0 198,28.653776 198,64 C198,99.346224 169.346224,128 134,128 L64,128 C28.653776,128 0,99.346224 0,64 C0,28.653776 28.653776,7.10542736e-15 64,0 L134,0 Z M134,32 C116.326888,32 102,46.326888 102,64 C102,81.673112 116.326888,96 134,96 C151.673112,96 166,81.673112 166,64 C166,46.326888 151.673112,32 134,32 Z";
    var KAIWU_TEXT_PATHS =
      '<path d="M63.8674033,3.63797881e-12 L63.8673004,0.0408920185 C85.819203,0.998626345 103.314917,18.6592734 103.314917,40.3053435 C103.314917,61.9514136 85.819203,79.6120607 63.8673004,80.569795 L63.8674033,80.610687 L39.447,80.61 L39.4475138,120 L0,120 L0,3.63797881e-12 L63.8674033,3.63797881e-12 Z M51.6574586,27.480916 L39.447,27.48 L39.447,51.297 L51.6574586,51.2977099 C58.4008248,51.2977099 63.8674033,45.966139 63.8674033,39.389313 C63.8674033,32.8124869 58.4008248,27.480916 51.6574586,27.480916 Z"/>' +
      '<path d="M182.209945,3.63797881e-12 L182.209842,0.0408920185 C204.161744,0.998626345 221.657459,18.6592734 221.657459,40.3053435 C221.657459,54.5742664 214.054967,67.1113855 202.58505,74.2738802 L231.049724,120 L182.209945,120 L157.789541,80.772 L157.790055,120 L118.342541,120 L118.342541,3.63797881e-12 L182.209945,3.63797881e-12 Z M170,27.480916 L157.789541,27.48 L157.789541,51.297 L170,51.2977099 C176.743366,51.2977099 182.209945,45.966139 182.209945,39.389313 C182.209945,32.8124869 176.743366,27.480916 170,27.480916 Z"/>' +
      '<path d="M317.458564,7.10542736e-13 L364.41989,120 L324.972376,120 L318.518724,103.511 L276.949724,103.511 L270.497238,120 L231.049724,120 L278.01105,3.99325017e-12 L317.458564,7.10542736e-13 Z M297.734724,50.4 L288.421724,74.198 L307.047724,74.198 L297.734724,50.4 Z"/>' +
      '<path d="M413.259669,7.10542736e-13 L431.10489,25.334 L448.950276,3.99325017e-12 L497.790055,3.99325017e-12 L455.52489,60 L497.790055,120 L448.950276,120 L431.10489,94.666 L413.259669,120 L364.41989,120 L406.68489,60 L364.41989,7.10542736e-13 L413.259669,7.10542736e-13 Z"/>' +
      '<rect x="512.81768" y="0" width="39.4475138" height="120"/>' +
      '<path d="M680,3.63797881e-12 L680,46.1538454 C650.993523,46.1538454 627.1056,78.4613165 623.990444,119.998691 L567.292818,119.999998 L567.292818,73.8461527 C596.299341,73.8461527 620.187294,41.5385785 623.302389,0.0011087754 L680,3.63797881e-12 Z"/>';
    var KAIWU_TEXT_SVG = '<g transform="translate(230,4)" fill="currentColor">' + KAIWU_TEXT_PATHS + '</g>';
    function kaiwuMark(h) {
      return '<svg viewBox="0 0 198 128" width="' + Math.round(h * 198 / 128) + '" height="' + h + '" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="' + KAIWU_MARK_PATH + '"/></svg>';
    }
    function kaiwuLogo(h) {
      return '<svg viewBox="0 0 910 128" width="' + Math.round(h * 910 / 128) + '" height="' + h + '" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="' + KAIWU_MARK_PATH + '"/>' + KAIWU_TEXT_SVG + '</svg>';
    }
    function kaiwuPraxis(h) {
      return '<svg viewBox="0 0 680 120" width="' + Math.round(h * 680 / 120) + '" height="' + h + '" fill="currentColor" aria-hidden="true">' + KAIWU_TEXT_PATHS + '</svg>';
    }
    ...
    function createPlazaEntry(t) {
      ...
      entry.innerHTML = '<span class="kwp-entryIcon">' + ENTRY_ICON + '</span><span class="kwp-entryLabel">' + t("navPlaza") + '</span><span class="kwp-entryLogo">' + kaiwuPraxis(13) + '</span>';
        ...
        React.createElement("div", { className: "kwp-topbar" },
          ...
          view === "plaza"
            ? React.createElement("div", { className: "kwp-topRight" },
                ...
                React.createElement("span", { className: "kwp-logo", dangerouslySetInnerHTML: { __html: kaiwuLogo(18) } })
              )
            : null
        ),
        view === "admin"
