...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var KAIWU_TEXT_SVG = '<g transform="translate(230,4)" fill="currentColor">' +
    ...
    function createPlazaEntry(t) {
      ...
      entry.innerHTML = '<span class="kwp-entryIcon">' + ENTRY_ICON + '</span><span class="kwp-entryLabel">' + t("navPlaza") + '</span><span class="kwp-entryLogo">' + kaiwuMark(15) + '</span>';
