  ...
  factory: function (require) {
    ...
    function mountBrandSwap() {
      ...
      function applySidebarBrand() {
        ...
        // 折叠 rail 里的鱼标也隐藏，避免残留 deepseek
        var railMark = root.querySelector("[class*='brandMark']");
        if (railMark && railMark.getAttribute("data-kaiwu") !== "1") {
          railMark.setAttribute("data-kaiwu", "1");
          railMark.innerHTML = '<img class="kwp-kwlogo" src="' + KAIWU_SIDEBAR_PNG + '" alt="开物" style="height:22px;width:auto;display:block"/>';
        }
      }
      function applyHeroBrand() {
        ...
        swapOnce(headline, "hero", '<img class="kwp-kwlogo" src="' + KAIWU_HERO_PNG + '" alt="开物成务" style="height:56px;width:auto;display:block;max-width:100%"/>');
      }
